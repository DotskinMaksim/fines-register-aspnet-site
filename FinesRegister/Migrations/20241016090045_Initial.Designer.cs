...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinesRegister.Models.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinesRegister.Models.Car", b =>
                {
                    b.HasOne("FinesRegister.Models.User", "User")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("FinesRegister.Models.Fine", b =>
                {
                    b.HasOne("FinesRegister.Models.Car", "Car")
                        .WithMany("Fines")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinesRegister.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
